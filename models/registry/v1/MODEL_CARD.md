# Model Card — Spread Forecaster v1

- **Created:** 2026-06-11T21:34:37
...
|---|---:|
| mean pinball ↓ | 2.555 |
| interval coverage (→80%) | 70% |
| capture rate (dollars) ↑ | 57.4% |

### vs. persistence baseline
| Metric | Model | Persistence |
|---|---:|---:|
| mean pinball | 2.555 | 3.635 |
| capture rate | 57.4% | 36.1% |
